...
## 项目4：CSS动画
学习了CSS3中的转换、过渡和动画等知识，运用所学知识绘制一幅美丽的蓝天白云绿草、小兔嬉耍的美景。
![项目4效果图](./4-css3-2-14/img/rendering.png)
### 任务描述
一、整体分块：
...
## 项目5：轮播图
学习了JavaScript的语法、流程控制语句、内置对象以及DOM和BOM的知识，完成如下图所示的交互效果————轮播图。

![项目5效果图](./5-js-3-8/img/rendering.jpg)

### 任务描述
一、语言和环境

     1、实现语言:HTML、CSS、JavaScript
